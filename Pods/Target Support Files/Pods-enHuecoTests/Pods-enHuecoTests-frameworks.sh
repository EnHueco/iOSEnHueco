...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-enHuecoTests/Alamofire_Synchronous.framework"
  ...
  install_framework "Pods-enHuecoTests/PureLayout.framework"
  install_framework "Pods-enHuecoTests/QRCodeReaderViewController.framework"
  install_framework "Pods-enHuecoTests/RSKImageCropper.framework"
